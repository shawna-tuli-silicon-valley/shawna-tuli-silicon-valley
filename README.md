Shawna Tuli is a seasoned ***Artificial Intelligence & Data Science*** and ***Strategy*** Leader, Innovator, Artificial Intelligence Engineer, Data Scientist, Xoogler, Venture Capitalist*, and San Jose native in Silicon Valley, with four years of experience as an Artificial Intelligence & Advanced Analytics Associate Manager at **Accenture** and **Avanade**, the Accenture **Microsoft** Business Group. She has a strong background in ***strategy & consulting***, particularly in ***generative artificial intelligence***, ***artificial intelligence***, ***data science***, ***advanced analytics***, ***software engineering***, ***business intelligence***, ***product strategy***, ***predictive modeling***, and ***CFO & enterprise value***. 
...
[(LinkedIn)](https://linkedin.com/in/shawna-tuli-silicon-valley) [(Accenture Data & AI, Applied Intelligence, Strategy Google Scholar)](https://scholar.google.com/citations?hl=en&user=7F6YV8MAAAAJ) [(UCI ICS Google Scholar)](https://scholar.google.com/citations?user=72mqLEoAAAAJ&hl=en) [(UCI Merage Credly)](https://www.credly.com/users/shawna-tuli/badges)
...
* 🌲 Stanford University Girl Code - sponsored as 1 of 12 Top Math & Computer Science High School Students [(Repo)](https://github.com/shawna-tuli-silicon-valley/stanford-engineering-computer-science) [(Article)](https://cs.stanford.edu/sites/default/files/Girl%20Code.pdf)
...
* Generative Artificial Intelligence, Large Language Models, GitHub CoPilot, Hugging Face, Gemini, AI Ethics
![ChatGPT](https://img.shields.io/badge/chatGPT-74aa9c?style=for-the-badge&logo=openai&logoColor=white) ![Heroku](https://img.shields.io/badge/heroku-%23430098.svg?style=for-the-badge&logo=heroku&logoColor=white)
...
#### DATA SCIENCE SKILLS
* Data Science, Pandas, Keras, Matplotlib, NumPy, Seaborn, Scikit-learn
