...
Shawna Tuli is a seasoned San Francisco & Mountain View ***Artificial Intelligence & Data Science***, ***Advanced Analytics***, and ***Strategy*** Leader, Innovator, Xoogler, and San Jose native, with close to five years of experience as an Artificial Intelligence & Advanced Analytics Associate Manager at **Accenture**, an Artificial Intelligence Company, and **Avanade**, the Accenture **Microsoft** Business Group. She has a strong background in ***artificial intelligence***, interlacing ***generative artificial intelligence***, ***artificial intelligence***, ***data science***, ***advanced analytics***, ***software engineering***, ***business intelligence***, ***product strategy***, ***predictive modeling***, and ***CFO & enterprise value***. Shawna is on the Executive and Corporate Board Director path. 
