...
* 👠 Avanade Northern California Social & Networking Champion - holding events for 50+
...
* ❤️ Google I/O Conference (6x) [(Keynote '24)](https://io.google/2024/)
...
* 🤍 Google Cloud Next Conference (4x) [(Next '24)](https://cloud.withgoogle.com/next/session-library?filters=vod-video-available#all)
