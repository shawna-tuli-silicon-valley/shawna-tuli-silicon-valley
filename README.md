Shawna Tuli is a seasoned professional, Xoogler, and Bay Area native in Silicon Valley, with three and a half years of experience as an Artificial Intelligence & Advanced Analytics Associate Manager at **Accenture** and **Avanade**, the Accenture **Microsoft** Business Group. She has a strong background in ***strategy & consulting***, particularly in ***generative artificial intelligence***, ***artificial intelligence***, ***data science***, ***advanced analytics***, and ***CFO & enterprise value***. 
...
* 🆕 Accenture V360 Awards in Innovation nominee for using LLMs to revolutionize call centers in California [(Repo)](https://github.com/shawna-tuli-silicon-valley/accenture-call-centers-genai-and-predictive-analytics) (Student Repo)
...
* 📦 AI & Data Science Lead at Amazon Mountain View - analyzing and predicting on migrated mailboxes' PB of data [(Repo)](https://github.com/shawna-tuli-silicon-valley/amazon-mountain-view-ai-and-data-science/tree/main) [(Article)](https://www.pcmag.com/news/amazon-to-spend-over-1-billion-on-microsoft-365-licenses)
...
* 🥇 Olympics Games Bayesian Data Analysis - analyzed U.S. athletes' chances of winning a gold medal in the Olympics [(Repo)](https://github.com/shawna-tuli-silicon-valley/uci-ics-olympic-games-bayesian-data-analysis)
...
* 📷 Technical Business Analyst Intern at Google Photos Mountain View - analyzed global 1B+ users' 2.5B photos daily [(Repo)](https://github.com/shawna-tuli-silicon-valley/google-mountain-view-product-analytics-data-science-1) [(Article)](https://9to5google.com/2018/12/28/google-photos-news-2018-recap/)
...
* 🚀 Data Scientist at UCI Beall Applied Innovation - analyzed and tracked trends of $14.5B+ in revenue early-stage startups [(Repo)](https://github.com/shawna-tuli-silicon-valley/uci-beall-applied-innovation-product-analytics-data-science)
...
* 🛍️ Data Scientist Intern at eBay San Jose in the Office of the Chief Information Officer [(Repo)](https://github.com/shawna-tuli-silicon-valley/ebay-san-jose-product-analytics-data-science) 
...
* University of California, Irvine Paul Merage School of Business - Alpha Kappa Psi Professional Business Fraternity | Pi Psi Professional Chair and Most Likely to be a Billionaire Award, UptoUCI Co-Founder & Marketing Director and Top 20 Team and Top Pledge Earner Badges, Student Managed Investment Fund Executive Vice President and CFA Society Orange County Request for Proposal Second Place, CFA Society Orange County Research Challenge, and CFA Society Orange County
...
* Azure, Azure Cosmos DB, Azure DevOps, Azure Active Directory, Azure Pipelines, Visual Studio, Microsoft SQL Server, Microsoft Azure SQL Database, Kubernetes, Power BI
